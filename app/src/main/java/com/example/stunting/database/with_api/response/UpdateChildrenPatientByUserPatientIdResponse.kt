...
@Parcelize
data class UpdateChildrenPatientByUserPatientIdResponse(

	@field:SerializedName("dataUpdateChildrenPatienttByUserPatientId")
	val dataUpdateChildrenPatienttByUserPatientId: DataUpdateChildrenPatienttByUserPatientId? = null,
...
@Parcelize
data class DataUpdateChildrenPatienttByUserPatientId(
