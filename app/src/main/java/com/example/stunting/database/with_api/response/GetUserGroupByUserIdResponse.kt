...
@Parcelize
data class GetUserGroupByUserIdResponse(

	@field:SerializedName("dataUserGroupByUserId")
	val dataUserGroupByUserId: List<DataUserGroupByUserIdItem?>? = null,
...
@Parcelize
data class DataUserGroupByUserIdItem(
