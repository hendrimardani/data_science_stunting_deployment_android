...
@Parcelize
data class AddingChildrenPatientByUserPatientIdResponse(

	@field:SerializedName("message")
	val message: String? = null,

	@field:SerializedName("dataChildrenPatient")
	val dataChildrenPatient: DataChildrenPatient? = null,
...
@Parcelize
data class DataChildrenPatient(
